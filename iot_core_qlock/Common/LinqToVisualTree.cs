...
namespace LinqToVisualTree
{
    ...
    public static class TreeExtensions
    {
        ...
        /// <summary>
        /// Returns a collection of Children which match the given type.
        /// </summary>
    ...
    public static class EnumerableTreeExtensions
    {
        ...
        public static string DUMP(this DependencyObject o)
        {
            string tree = o.DescendantsAndSelf().Aggregate("",
